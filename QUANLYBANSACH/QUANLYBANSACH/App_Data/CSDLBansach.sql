...
ALTER TABLE CTDATHANG ADD CONSTRAINT FK_CTDatHang_Sach FOREIGN KEY (MaSach) REFERENCES SACH(MaSach)
...
INSERT [dbo].[QUANGCAO] ([STT], [TenCongTy], [HinhMinhHoa], [HREF], [Ngaybatdau], [NgayHetHan]) VALUES (1, N'Thời trang Việt Nam', N'Thoitrang.gif', N'http://www.vietfashion.vn/', CAST(0x96500000 AS SmallDateTime), CAST(0x9CBD0000 AS SmallDateTime))
INSERT [dbo].[QUANGCAO] ([STT], [TenCongTy], [HinhMinhHoa], [HREF], [Ngaybatdau], [NgayHetHan]) VALUES (2, N'Bột giặt Omo', N'Omo.gif', N'http://www.haydetretudo.com.vn/', CAST(0x96500000 AS SmallDateTime), CAST(0x9EFE0000 AS SmallDateTime))
INSERT [dbo].[QUANGCAO] ([STT], [TenCongTy], [HinhMinhHoa], [HREF], [Ngaybatdau], [NgayHetHan]) VALUES (3, N'Bánh Trung thu', N'Trungthu.gif', N'http://demo10.webinvietnam.com/For_Ad/h/hanobaco/', CAST(0x96500000 AS SmallDateTime), CAST(0x9E480000 AS SmallDateTime))
INSERT [dbo].[QUANGCAO] ([STT], [TenCongTy], [HinhMinhHoa], [HREF], [Ngaybatdau], [NgayHetHan]) VALUES (4, N'Sữa Cô gái Hà Lan', N'Fristi.gif', N'http://www.dutchlady.com.vn', CAST(0x96500000 AS SmallDateTime), CAST(0x9E2A0000 AS SmallDateTime))
...
Xin trân trọng giới thiệu cuốn sách cùng bạn', N'THCB.jpg', 7, 1, CAST(0x95270000 AS SmallDateTime), 120, 0)
...
Xin trân trọng giới thiệu cùng các bạn.', N'LTWeb2005.jpg', 8, 4, CAST(0x95280000 AS SmallDateTime), 240, 0)
...
Xin trân trọng giới thiệu Tập 1 cùng các bạn.', N'130499.jpg', 10, 5, CAST(0x94E80000 AS SmallDateTime), 65, 0)
...
Test thu', N'Gt_Thcb.jpg', 3, 6, CAST(0x95450000 AS SmallDateTime), 5, 0)
...
', N'KT0001.jpg', 9, 8, CAST(0x93F60000 AS SmallDateTime), 5, 0)
...
', N'KT0001.jpg', 5, 6, CAST(0x93E20000 AS SmallDateTime), 89, 0)
...
Xin trân trọng giới thiệu cuốn sách cùng bạn. ', N'KT0001.jpg', 11, 3, CAST(0x93F90000 AS SmallDateTime), 8, 0)
...
', N'KT0001.jpg', 4, 8, CAST(0x93B70000 AS SmallDateTime), 4, 0)
...
Tập thể tác giả tham gia công trình này đều là những người chuyên nghiên cứu về Trung Quốc, hy vọng sẽ đem lại cho các bạn nhiều thông tin bổ ích.', N'KT0001.jpg', 1, 7, CAST(0x94E80000 AS SmallDateTime), 19, 0)
...
Sử dụng cuốn 30 phút mỗi ngày để luyện kỹ năng viết câu tiếng Anh này sẽ giúp học sinh/sinh viên viết “có nghề” và tự tin hơn".', N'TiengAnh01.jpg', 2, 1, CAST(0x8FB30000 AS SmallDateTime), 7, 0)
...
Bộ sách được chia làm 2 tập, tập 1 đề cập các kiến thức cơ bản về CSDL, mô hình dữ liệu. Bạn sẽ được biết về hệ quản trị CSDL Oracle9i, tạo CSDL, kết nối và quản lý người dùng. Tập 2 hướng dẫn bạn cách nạp, sao lưu và phục hồi dữ liệu, quản lý hoạt động CSDL Oracle9i, thực hiện hiệu chỉnh hiệu suất thực thi và xử lý sự cố cho CSDL.
Xin trân trọng giới thiệu Tập 1 cùng các bạn. ', N'TH001.jpg', 1, 2, CAST(0x93F60000 AS SmallDateTime), 28, 0)
...
', N'TH001.jpg', 4, 1, CAST(0x924B0000 AS SmallDateTime), 4, 0)
...
Trân trọng giới thiệu. 
', N'TH001.jpg', 6, 7, CAST(0x955F0000 AS SmallDateTime), 5, 0)
...
', N'TH001.jpg', 5, 5, CAST(0x94E80000 AS SmallDateTime), 8, 0)
...
Xin trân trọng giới thiệu. ', N'TH002.jpg', 1, 6, CAST(0x95450000 AS SmallDateTime), 56, 0)
...
', N'TH002.jpg', 5, 7, CAST(0x93B70000 AS SmallDateTime), 4, 0)
INSERT [dbo].[SACH] ([Masach], [Tensach], [DonGia], [Donvitinh], [Mota], [Hinhminhhoa], [MaCD], [MaNXB], [Ngaycapnhat], [Soluongban], [Solanxem]) VALUES (21, N'Tin Học Văn Phòng - Microsoft Word 2000 (Tái Bản Lần Thứ Nhất) ', 15600, N'Cuốn', N' ', N'TH002.jpg', 2, 8, CAST(0x931D0000 AS SmallDateTime), 6, 0)
...
', N'TH002.jpg', 5, 5, CAST(0x91EC0000 AS SmallDateTime), 8, 0)
INSERT [dbo].[SACH] ([Masach], [Tensach], [DonGia], [Donvitinh], [Mota], [Hinhminhhoa], [MaCD], [MaNXB], [Ngaycapnhat], [Soluongban], [Solanxem]) VALUES (23, N'Hướng Dẫn Tự Học Photoshop CS (Photoshop 8.0) ', 25000, N'Cuốn', N' ', N'TH003.jpg', 8, 4, CAST(0x983E0000 AS SmallDateTime), 9, 0)
...
Xin trân trọng giới thiệu. 
', N'TH003.jpg', 6, 5, CAST(0x93830000 AS SmallDateTime), 1, 0)
